...
<?php include "header.php" ?>
  ...
  <div class="card-body">
    ...
    <h3>Custom List Email OutBox</h3>
  </div>
<table class="table table-striped table-bordered">
        ...
        // Get member rows
        $count = 1;
        $result = $con->query("SELECT * FROM custom_member_details where status='Done' ORDER BY id DESC LIMIT 500");
        ...
        ?>
            <tr>
                ...
                <td><button type="button" class="btn btn-warning"><a href="custom_bill_done.php?d_no=<?php echo $row['d_no']; ?>">View Receipt</a></button></td>
            </tr>
        <?php } }else{ ?>
