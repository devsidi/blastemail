<?php
  ...
  $query = "SELECT * FROM member_details where status='Done' AND membership_no = $membership_no";
...
$pdf->SetFont('Times','BU',12); 
$pdf->Cell(65,-66, 'RM '.$entryfee, 0, 2, 'C');
}
$pdf->Cell(0,6,"",0,1,'L'); 
$pdf->SetFont('Times','',12); 
...
$pdf->SetFont('Times','BU',12);
$pdf->Cell(104,55, 'RM '.$donation, 0, 2, 'C');
}
$pdf->Cell(0,6,"",0,1,'L');
$pdf->SetFont('Times','',12); 
